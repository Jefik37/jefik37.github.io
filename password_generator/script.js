...
document.getElementById('password_length_slider').addEventListener('input', generate_password);
document.getElementById('password_length').addEventListener('input', generate_password);
